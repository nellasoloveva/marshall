...
if (counter == 1) {
  ...
  otz.textContent = `I recently purchased a Marshall headphone, and I couldn't be happier. Not only do they look fantastic with that classic Marshall design, but the comfort and sound performance are top-notch. They’re great for long listening sessions without any discomfort. Definitely worth the investment!`;
